...
class ModelTrainer():
    ...
    def __init__(self, sklearn_model, params:dict, row_data_data, row_data_target, f_eval=accuracy_score, scaler = StandardScaler, CFeature = train_test_split, CV = KFold, thread_cnt=8):
    ...
    def analyze_model(self, parameter_set):
        ...
        print("Score: ",self.f_eval(self.y_test, y_pred))
...
if __name__ == "__main__":  
    ...
    modeltrainer = ModelTrainer(DecisionTreeRegressor, params, iris_data, iris_target, r2_score, StandardScaler, train_test_split, KFold, thread_cnt=4)
